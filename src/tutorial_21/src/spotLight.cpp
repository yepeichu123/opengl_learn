...
const char* pVSFileName = "/home/xiaoc/xiaoc/code/opengl/stepByStep/src/tutorial_21/shader/shader.vs";
const char* pFSFileName = "/home/xiaoc/xiaoc/code/opengl/stepByStep/src/tutorial_21/shader/shader.fs";
const char* textureImageFile = "/home/xiaoc/xiaoc/code/opengl/stepByStep/src/tutorial_21/data/test.png";
...
class spotLight : public ICallbacks//, public OgldevApp
{
public:
...
//    Magick::InitializeMagick(*argv);
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, false, "spotLight")) {
        return 1;
    }

    spotLight* pApp = new spotLight();
