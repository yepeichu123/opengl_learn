...
const char* pVSFileName = "/home/xiaoc/xiaoc/code/opengl/stepByStep/src/tutorial_13/shader/shader.vs";
const char* pFSFileName = "/home/xiaoc/xiaoc/code/opengl/stepByStep/src/tutorial_13/shader/shader.fs";
...
static void RenderSceneCB() {
    ...
    Vector3f CameraPos(0.0f, 2.0f, -3.0f);
    Vector3f CameraTarget(0.0f, 0.0f, 6.0f);
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("cameraCoordinate");
